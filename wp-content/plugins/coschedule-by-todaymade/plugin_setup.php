            ...
            <div class="setup-box">
                ...
                <div class="sign-in setup-section">
                    ...
                    <div class="form marg-t">
                        ...
                        <div class="links">
                            <a target="_blank" class="sign-up" href="https://coschedule.com/signup">Need an account?</a>
                            <a target="_blank" class="forgot-password" href="https://app.coschedule.com/#/forgot_password">Forgot your password?</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="calendar-pick setup-section hide">
                    ...
                    <div class="calendar-container">
                        ...
                        <div class="calendar-options-wrapper" style="width: 100%;"></div>

                        <div class="calendar-option create-new">
                            <div class="cal">
                                <span class="name">Create a New Calendar</span>
                                <input class="input input-block-level" type="text" name="" id="new-calendar-name-pick" placeholder="Calendar Name">

                            </div>
                        </div>

                        <button type="submit" class="btn btn-orange btn-block default hide create-calendar-button" id="">Create Calendar</button>
                        <a class='cancel-create hide'>Cancel</a>
