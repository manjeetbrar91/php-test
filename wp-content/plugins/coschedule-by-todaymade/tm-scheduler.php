...
if ( ! class_exists( 'tm_coschedule' ) ) {
    ...
    class TM_CoSchedule {
        ...
        public function edit_post_callback() {
            ...
            // It also leads to excessively sending save_post jobs as one will be sent every time that page is loaded. (Example: Load page, hit update and page reloads = 3 saves
            // This could potentially be refactored to check a post_meta value indicating if the post has already been synced with CoSchedule.
            if ( isset( $_GET['post'] ) ) {
                $post_id = $_GET['post'];
                $this->sanitize_param( $post_id );
