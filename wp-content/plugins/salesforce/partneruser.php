		...
		if(isset($_POST['submit']))
			{
				...
				if(trim($security_question)!=null && trim($answer)!=null && trim($first_name)!=null && trim($last_name)!=null && trim($email)!=null && trim($company)!=null)
				{
...
//account full contact api
								...
								$msg=set_okta_zendesk_account($email,$first_name,$last_name,$password,$contact_type,$security_question,$answer);							
					...
					catch (Exception $e) 
					{
						...
						writeToLog($e->getMessage(),__LINE__,__FILE__);
					}
				}
				else
				{
		...
		<div class="partner-form-container wpb_column vc_column_container ">
			<div class="vc_column-inner ">
				<div class="wpb_wrapper">
					...
					<h2 style="font-size: 28px;text-align: left" class="vc_custom_heading">Please fill out a registration form to join Wine-Oh!</h2>
					<?php
						if(trim($msg)!=null) 
						{
							?>
...
<div  id="error" class="alert alert-success-theme" style="display: none;">
 ...
 autocomplete="off"> 
						...
						<select style="width:100% !important;" id="security_question" name="security_question">
						...
						and my answer is  
						<input style="width:78% !important;" id="answer" name="answer"  type="text"  placeholder="Answer"  autocomplete="off">
						<br/>
						</p>
